...
class TestUserService(BaseTestCase):
    ...
    def test_add_user_invalid_json_keys(self):
        ...
        with self.client:
            response = self.client.post(
                '/users',
                data=json.dumps(dict(email='michael@realpython.com',password='123')),
                content_type='application/json',
            )
            data = json.loads(response.data.decode())
            self.assertEqual(response.status_code, 400)
    ...
    def test_single_user(self):
        ...
        user = add_user('michael', 'michael@realpython.com','123')
        with self.client:
    ...
    def test_all_users(self):
        ...
        add_user('michael', 'michael@realpython.com', '123',created)
        add_user('fletcher', 'fletcher@realpython.com','123')
        with self.client:
